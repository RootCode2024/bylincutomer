              ...
              <div>
                  ...
                  <div class="mt-6">
                    ...
                    <div class="mt-6 space-y-3">
                      <button 
                        ...
                        class="w-full disabled:cursor-not-allowed disabled:opacity-50 flex items-center justify-center gap-3 px-4 py-3 border-2 border-gray-200 rounded-lg hover:border-indigo-700 hover:bg-indigo-50 transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98]"
                      >
                      ...
                      <span class="text-gray-700 font-medium" v-if="!socialLoading">Se connecter avec Google</span>
                      <svg 
                        v-else 
                ...
                <div v-if="step === 'other'" key="other">
                  <div class="text-center mb-8">
                    ...
                    <h1 class="text-2xl font-bold text-gray-900 mb-2">
                      <span class="italic text-indigo-700">bylin</span>, la grandeur depuis les racines!
                    </h1>
                    <p class="text-gray-600">Entrez vos coordonnées pour vous inscrire.</p>
                  </div>
                ...
                <div v-else-if="step === 'code'" key="code">
                  <div class="text-center mb-8">
                    <transition name="bounce" appear>
                      <div class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-indigo-700 to-indigo-800 rounded-2xl mb-4 shadow-lg">
                    ...
                    <p class="text-indigo-800 font-medium">{{ email }}</p>
                  ...
                  <form @submit.prevent="handleCodeSubmit" class="space-y-6">
                    ...
                    <button
                      ...
                      class="w-full disabled:cursor-not-allowed disabled:opacity-80 bg-gradient-to-r from-indigo-700 to-indigo-800 hover:from-indigo-800 hover:to-indigo-900 text-white font-medium py-3 rounded-lg transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98] shadow-lg hover:shadow-xl"
                    >
